...
#
# Integration test runner for the fedora image.
# Covers: fedora, fedora-rawhide
#
# Usage: fedora.sh <backend> <mode>
...
IMAGE="fedora"
CONTAINER_BASIC="otter-test-fedora"
CONTAINER_FULL="otter-test-fedora-full"
REPORT_FILE="test-report-fedora-${BACKEND}-${MODE}.txt"
FAILURES=0
...
printf "=== Integration Test: fedora | backend=%s | mode=%s ===\n" \
...
printf "\n=== Results: fedora | backend=%s | mode=%s ===\n" \
