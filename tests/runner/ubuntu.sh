...
#
# Integration test runner for the ubuntu image.
#
# Usage: ubuntu.sh <backend> <mode>
...
IMAGE="ubuntu"
CONTAINER_BASIC="otter-test-ubuntu"
CONTAINER_FULL="otter-test-ubuntu-full"
REPORT_FILE="test-report-ubuntu-${BACKEND}-${MODE}.txt"
FAILURES=0
...
printf "=== Integration Test: ubuntu | backend=%s | mode=%s ===\n" \
...
printf "\n=== Results: ubuntu | backend=%s | mode=%s ===\n" \
