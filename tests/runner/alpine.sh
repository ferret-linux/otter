...
#
# Integration test runner for the alpine image.
# Covers: alpine, alpine-edge
#
# Usage: alpine.sh <backend> <mode>
...
IMAGE="alpine"
CONTAINER_BASIC="otter-test-alpine"
CONTAINER_FULL="otter-test-alpine-full"
REPORT_FILE="test-report-alpine-${BACKEND}-${MODE}.txt"
FAILURES=0
...
printf "=== Integration Test: alpine | backend=%s | mode=%s ===\n" \
...
printf "\n=== Results: alpine | backend=%s | mode=%s ===\n" \
