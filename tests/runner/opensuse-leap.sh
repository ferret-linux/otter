...
#
# Integration test runner for the opensuse-leap image.
# Covers: opensuse-leap, opensuse-tumbleweed
#
# Usage: opensuse-leap.sh <backend> <mode>
...
IMAGE="opensuse-leap"
CONTAINER_BASIC="otter-test-opensuse"
CONTAINER_FULL="otter-test-opensuse-full"
REPORT_FILE="test-report-opensuse-leap-${BACKEND}-${MODE}.txt"
FAILURES=0
...
printf "=== Integration Test: opensuse-leap | backend=%s | mode=%s ===\n" \
...
printf "\n=== Results: opensuse-leap | backend=%s | mode=%s ===\n" \
