  ...
  if (palette != NULL)
    {
      ...
      g_autofree char *user_palettes_dir = bevy_get_user_palettes_dir ();
...
gint64
bevy_application_get_default_rlimit_nofile (void)
{
...
main (int   argc,
      char *argv[])
{
  g_autoptr(BevyApplication) app = NULL;
  ...
  g_set_prgname ("bevy");
  g_set_application_name (bevy_app_name ());
  ...
  app = bevy_application_new (APP_ID, flags);
