...
struct _BevyShortcutAccelDialog
{
...
G_DEFINE_FINAL_TYPE (BevyShortcutAccelDialog, bevy_shortcut_accel_dialog, ADW_TYPE_DIALOG)

static void
bevy_shortcut_accel_dialog_update_reset_button (BevyShortcutAccelDialog *self);

static gboolean
bevy_shortcut_accel_dialog_is_editing (BevyShortcutAccelDialog *self)
{
  g_assert (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self));

  return self->editing;
}

static void
bevy_shortcut_accel_dialog_apply_state (BevyShortcutAccelDialog *self)
{
  g_assert (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self));
...
static gboolean
bevy_shortcut_accel_dialog_key_pressed (GtkWidget             *widget,
                                          guint                  keyval,
                                          guint                  keycode,
                                          GdkModifierType        state,
                                          GtkEventControllerKey *controller)
{
  BevyShortcutAccelDialog *self = (BevyShortcutAccelDialog *)widget;
  ...
  if (bevy_shortcut_accel_dialog_is_editing (self))
    {
      ...
      if (real_mask == 0 && keyval_lower == GDK_KEY_BackSpace)
        {
          bevy_shortcut_accel_dialog_set_accelerator (self, NULL);
      ...
      bevy_shortcut_accel_dialog_apply_state (self);

      g_object_notify_by_pspec (G_OBJECT (self), properties [PROP_ACCELERATOR]);
      bevy_shortcut_accel_dialog_update_reset_button (self);
...
static void
bevy_shortcut_accel_dialog_key_released (GtkWidget             *widget,
                                           guint                  keyval,
                                           guint                  keycode,
                                           GdkModifierType        state,
                                           GtkEventControllerKey *controller)
...
static void
shortcut_set_cb (BevyShortcutAccelDialog *self)
{
      g_signal_emit (self, signals [SHORTCUT_SET], 0,
                     bevy_shortcut_accel_dialog_dup_accelerator (self));

  adw_dialog_close (ADW_DIALOG (self));
}

static void
shortcut_reset_cb (BevyShortcutAccelDialog *self)
{
  g_assert (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self));

  if (self->default_accelerator != NULL)
    {
      bevy_shortcut_accel_dialog_set_accelerator (self, self->default_accelerator);
...
bevy_shortcut_accel_dialog_update_reset_button (BevyShortcutAccelDialog *self)
{
  ...
  current_accelerator = bevy_shortcut_accel_dialog_dup_accelerator (self);
...
static void
bevy_shortcut_accel_dialog_constructed (GObject *object)
{
  BevyShortcutAccelDialog *self = (BevyShortcutAccelDialog *)object;

  G_OBJECT_CLASS (bevy_shortcut_accel_dialog_parent_class)->constructed (object);
...
static void
bevy_shortcut_accel_dialog_finalize (GObject *object)
{
  BevyShortcutAccelDialog *self = (BevyShortcutAccelDialog *)object;
  ...
  G_OBJECT_CLASS (bevy_shortcut_accel_dialog_parent_class)->finalize (object);
}

static void
bevy_shortcut_accel_dialog_get_property (GObject    *object,
                                           guint       prop_id,
                                           GValue     *value,
                                           GParamSpec *pspec)
{
  BevyShortcutAccelDialog *self = BEVY_SHORTCUT_ACCEL_DIALOG (object);

  switch (prop_id)
    {
    case PROP_ACCELERATOR:
      g_value_take_string (value, bevy_shortcut_accel_dialog_dup_accelerator (self));
      break;

    case PROP_SHORTCUT_TITLE:
      g_value_set_string (value, bevy_shortcut_accel_dialog_get_shortcut_title (self));
      break;

    case PROP_DEFAULT_ACCELERATOR:
      g_value_set_string (value, bevy_shortcut_accel_dialog_get_default_accelerator (self));
      break;
...
static void
bevy_shortcut_accel_dialog_set_property (GObject      *object,
                                           guint         prop_id,
                                           const GValue *value,
                                           GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_ACCELERATOR:
      bevy_shortcut_accel_dialog_set_accelerator (self, g_value_get_string (value));
      break;

    case PROP_SHORTCUT_TITLE:
      bevy_shortcut_accel_dialog_set_shortcut_title (self, g_value_get_string (value));
      break;

    case PROP_DEFAULT_ACCELERATOR:
      bevy_shortcut_accel_dialog_set_default_accelerator (self, g_value_get_string (value));
      break;
...
static void
bevy_shortcut_accel_dialog_class_init (BevyShortcutAccelDialogClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);

  object_class->constructed = bevy_shortcut_accel_dialog_constructed;
  object_class->finalize = bevy_shortcut_accel_dialog_finalize;
  object_class->get_property = bevy_shortcut_accel_dialog_get_property;
  object_class->set_property = bevy_shortcut_accel_dialog_set_property;
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/dev/itznoel/Bevy/bevy-shortcut-accel-dialog.ui");

  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, accept_button);
  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, reset_button);
  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, display_label);
  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, display_shortcut);
  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, selection_label);
  gtk_widget_class_bind_template_child (widget_class, BevyShortcutAccelDialog, stack);
  gtk_widget_class_bind_template_callback (widget_class, bevy_shortcut_accel_dialog_key_pressed);
  gtk_widget_class_bind_template_callback (widget_class, bevy_shortcut_accel_dialog_key_released);
...
static void
bevy_shortcut_accel_dialog_init (BevyShortcutAccelDialog *self)
{
  self->editing = TRUE;
...
char *
bevy_shortcut_accel_dialog_dup_accelerator (BevyShortcutAccelDialog *self)
{
  g_return_val_if_fail (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self), NULL);
...
void
bevy_shortcut_accel_dialog_set_accelerator (BevyShortcutAccelDialog *self,
                                              const char                *accelerator)
{
  guint keyval;
  GdkModifierType state;

  g_return_if_fail (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self));
...
void
bevy_shortcut_accel_dialog_set_shortcut_title (BevyShortcutAccelDialog *self,
...
const char *
bevy_shortcut_accel_dialog_get_shortcut_title (BevyShortcutAccelDialog *self)
{
  g_return_val_if_fail (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self), NULL);
...
const char *
bevy_shortcut_accel_dialog_get_default_accelerator (BevyShortcutAccelDialog *self)
{
  g_return_val_if_fail (BEVY_IS_SHORTCUT_ACCEL_DIALOG (self), NULL);
...
void
bevy_shortcut_accel_dialog_set_default_accelerator (BevyShortcutAccelDialog *self,
...
GtkWidget *
bevy_shortcut_accel_dialog_new (void)
{
  return g_object_new (BEVY_TYPE_SHORTCUT_ACCEL_DIALOG, NULL);
}
