...
RUN apt-get install -y --no-install-recommends \
    ...
    gnupg gnupg2 gpgsm hostname iproute2 iputils-ping keyutils language-pack-en \
    less libcap2-bin libkrb5-3 libegl-mesa0 libegl1 libegl1-mesa libgl1 \
    libgl1-mesa-glx libglx-mesa0 libnss-mdns libnss-myhostname \
    libvte-common libvulkan1 locales lsof man-db manpages \
