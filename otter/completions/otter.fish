...
function __otter_perform_completion
    ...
    for line in $results
        if not string match -q -- "otter*" $line
...
# Clear existing completions for otter
complete -c otter -e
# Register completion function
complete -c otter -f -a '(__otter_perform_completion)'
