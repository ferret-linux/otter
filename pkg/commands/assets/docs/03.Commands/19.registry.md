...
images (see Images for the full list) described by a
...
Instead of presenting data in a tabular format, it presents a
scriptable JSON format (useful for scripts and external apps).
...
- Images — the full catalog of built-in images and
  distros.
